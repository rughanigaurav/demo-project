const FilterRow = (props) => {
  const { id, currentSheet,chartId, filterName, filterDocCount, isSelected, onSetGenerateChart } = props;
  const listFilters = props[currentSheet].listFilters ? props[currentSheet].listFilters : [];
  ...
  const handleClick = () => {
    ...
    onSetGenerateChart({[currentSheet] : { ...props[currentSheet], listFilters }});
  }
