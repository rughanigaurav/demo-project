...
const MergeRow = (props) => {
  const { item, onSelect, selectData, listMergeData, listMerge, chartId, onSetGenerateChart, currentSheet, onGetResult, onChangeChartDataAsPerMerge, id } = props;
  ...
  const handleRemove = (e) => {
    ...
    onSetGenerateChart({[currentSheet] : { ...props[currentSheet], listMerge: {...newListMerge} }});
